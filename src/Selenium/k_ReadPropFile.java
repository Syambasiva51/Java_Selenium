...
public class k_ReadPropFile {
	...
	public static void main(String[] args) throws IOException {
		...
		FileInputStream ip = new FileInputStream(
				"C:\\Users\\samba\\eclipse-workspace\\JAVA_Selenium_webdriver\\src\\Selenium\\K_config.properties");
		prop.load(ip);
		...
		driver.findElement(By.xpath(prop.getProperty("gmail_xpath"))).sendKeys(prop.getProperty("gmail"));
